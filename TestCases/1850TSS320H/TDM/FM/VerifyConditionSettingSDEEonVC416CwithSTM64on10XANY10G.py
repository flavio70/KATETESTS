...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"FM", "5-2-70-47")
        ...
        print("\n*******************************************************************")
        print("\tSTRUCTURE {} TO 4xAU416C".format(zq_rate))
        print("*******************************************************************")
        #ED-STM4::STM4-1-1-6-3::::HOSTRUCT=1xAU44C
        #
        QS_1300_Change_STMn_Structure(self, NE1, zq_rate, NE1_S1, "4xAU416C")
        ...
        for zq_au4_i in E_AU416C_STM64_IDX:
            QS_1000_Check_AU4_SST(self, NE1, zq_rate, NE1_S1, zq_au4_i, "SDEE", False, "16C")
        ...
        for zq_au4_i in E_AU416C_STM64_IDX:
            QS_1100_Create_AU4_XC(self, NE1, zq_rate, NE1_S1, zq_au4_i, zq_au4_i, "1WAY", "16C")
        ...
        for zq_au4_i in E_AU416C_STM64_IDX:
            QS_1000_Check_AU4_SST(self, NE1, zq_rate, NE1_S1, zq_au4_i, "SDEE", True, "16C")
        ...
        #
        for zq_au4_i in E_AU416C_STM64_IDX:
            QS_1200_Delete_AU4_XC(self, NE1, zq_rate, NE1_S1, zq_au4_i, zq_au4_i, "1WAY", "16C")
        ...
        self.stop_tps_block(NE1.id,"FM", "5-2-70-47")
