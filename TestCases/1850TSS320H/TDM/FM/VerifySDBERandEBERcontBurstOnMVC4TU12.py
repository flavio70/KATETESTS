...
bercont={'1BER5':'1','2BER5':'0','3BER5':'0',
         '1BER6':'0','2BER6':'1','3BER6':'0',
         '1BER7':'0','2BER7':'0','3BER7':'1',
         '1BER8':'0','2BER8':'0','3BER8':'0',
         '1BER9':'0','2BER9':'0','3BER9':'0'}

berburst={'1BER1':'0','2BER1':'0','3BER1':'1',
          '1BER10':'0','2BER10':'1','3BER10':'0',
          '1BER100':'0','2BER100':'0','3BER100':'0',
          '1BER1000':'1','2BER1000':'0','3BER1000':'0'}
...
def QS_090_Check_FAC_pst(zq_run, zq_slot, zq_vc4_1, zq_j, zq_m, zq_l, zq_pst):

    zq_filter=TL1check()
    zq_filter.add_pst(zq_pst)
    zq_tl1_res=NE1.tl1.do_until("RTRV-TU12::MVC4TU12-{}-{}-{}-{}-{};".format(zq_slot, zq_vc4_1, zq_j, zq_m, zq_l), zq_filter,timeout=E_TIMEOUT)
    if zq_tl1_res:
        zq_msg=TL1message(NE1.tl1.get_last_outcome())
        dprint(NE1.tl1.get_last_outcome(),1)
        zq_cmd=zq_msg.get_cmd_status()
        if zq_cmd == (True,'COMPLD'):
            dprint("OK\tPrimary Status successful changed to {} for MVC4TU12-{}-{}-{}-{}-{} facility.".
                   format(zq_pst, zq_slot, zq_vc4_1, zq_j, zq_m, zq_l),2)
            zq_run.add_success(NE1, "Primary Status successful changed to {} for MVC4TU12-{}-{}-{}-{}-{} facility.".
                               format(zq_pst, zq_slot, zq_vc4_1, zq_j, zq_m, zq_l),"0.0", "PRIMARY STATUS CHECK")
        else:
...
def QS_095_Check_MVC4TU12_Alarm(zq_run,zq_vc12,zq_man_exp,zq_type_exp,zq_dir_exp):
...
def QS_100_Check_SDBER(zq_run, 
    ...
    for zq_j in  E_TUG3:
        for zq_m in E_TUG2:
            for zq_l in E_TU12:
                zq_tu12_idx1="MVC4TU12-{}-{}-{}-{}-{}".format(zq_slot,str(zq_vc4_1),str(zq_j),str(zq_m),str(zq_l))
                zq_tu12_idx2="MVC4TU12-{}-{}-{}-{}-{}".format(zq_slot,str(zq_vc4_2),str(zq_j),str(zq_m),str(zq_l))
                ...
                if zq_mode == 'RATE':
                    if zq_rate == '1E-5' or \
                       ...
                       zq_rate == '1E-8' or \
                       zq_rate == '1E-9':
                        zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=POISSON,SDTH={},SFTH=3,EGSDSFMODE=POISSON,EGSDTH={},EGSFTH=3;".
                                              format(zq_tu12_idx1, zq_rate.replace("1E-",""), zq_rate.replace("1E-","")))
                        zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=POISSON,SDTH={},SFTH=3,EGSDSFMODE=POISSON,EGSDTH={},EGSFTH=3;".
                                              format(zq_tu12_idx2, zq_rate.replace("1E-",""), zq_rate.replace("1E-","")))
                    else:
                        zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=POISSON,SFTH={},SDTH=6,EGSDSFMODE=POISSON,EGSFTH={},EGSDTH=6;".
                                              format(zq_tu12_idx1, zq_rate.replace("1E-",""), zq_rate.replace("1E-","")))
                        zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=POISSON,SFTH={},SDTH=6,EGSDSFMODE=POISSON,EGSFTH={},EGSDTH=6;".
                                              format(zq_tu12_idx2, zq_rate.replace("1E-",""), zq_rate.replace("1E-","")))
                else:
                    zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=BURST,BRSTTH={},SDTH={},EGSDSFMODE=BURST,EGBRSTTH={},EGSDTH={};".
                                          format(zq_tu12_idx1, str(zq_num_err-1), zq_rate.replace("1E-",""), str(zq_num_err-1), zq_rate.replace("1E-","")))
                    zq_tl1_res=NE1.tl1.do("ED-TU12::{}::::SDSFMODE=BURST,BRSTTH={},SDTH={},EGSDSFMODE=BURST,EGBRSTTH={},EGSDTH={};".
                                          format(zq_tu12_idx2, str(zq_num_err-1), zq_rate.replace("1E-",""), str(zq_num_err-1), zq_rate.replace("1E-","")))
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"FM", "5-2-21-1")
        self.start_tps_block(NE1.id,"FM", "5-2-23-1")
        ...
        for zq_i in range(3,6):
            if eber.get('1EBER{}'.format(str(zq_i)))=='1':
        ...
        #
        for zq_i in range(3,6):
            if eber.get('2EBER{}'.format(str(zq_i)))=='1':
        ...
        #
        for zq_i in range(3,6):
            if eber.get('3EBER{}'.format(str(zq_i)))=='1':
        ...
        self.stop_tps_block(NE1.id,"FM", "5-2-21-1")
        self.stop_tps_block(NE1.id,"FM", "5-2-23-1")
