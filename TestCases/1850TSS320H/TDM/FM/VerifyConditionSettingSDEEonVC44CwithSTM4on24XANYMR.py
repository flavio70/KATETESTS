...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"FM", "5-2-70-41")
        ...
        #
        QS_1300_Change_STMn_Structure(self, NE1, zq_rate, NE1_S1, "1xAU44C")
        ...
        #
        QS_1000_Check_AU4_SST(self, NE1, zq_rate, NE1_S1, 1, "SDEE", False, "4C")
        ...
        QS_1100_Create_AU4_XC(self, NE1, zq_rate, NE1_S1, 1, 1, "1WAY", "4C")
        ...
        QS_1000_Check_AU4_SST(self, NE1, zq_rate, NE1_S1, 1, "SDEE", True, "4C")
        ...
        QS_1200_Delete_AU4_XC(self, NE1, zq_rate, NE1_S1, 1, 1, "1WAY", "4C")
        ...
        QS_1300_Change_STMn_Structure(self, NE1, zq_rate, NE1_S1, "4xAU4")

        
        self.stop_tps_block(NE1.id,"FM", "5-2-70-41")
