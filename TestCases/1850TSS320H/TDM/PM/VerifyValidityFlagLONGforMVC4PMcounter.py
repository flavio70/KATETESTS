...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        if QS_070_Check_No_Alarm(self, NE1, ONT, ONT_P1, ONT_P2, zq_vc4_ch1, zq_vc4_ch2):
            ...
            zq_time = QS_910_Wait_Quarter(NE1)
            time.sleep(zq_time)
            ...
            zq_date_time=QS_920_Get_Date_Time(NE1)
            zq_date = zq_date_time[0]
            zq_time = zq_date_time[1]
            zq_time_ary = zq_time.split(":")
            zq_time_ary[1] = str(int(zq_time_ary[1]) - 2)
            zq_time = "-".join(zq_time_ary)
            
            QS_900_Set_Date(self, NE1,zq_date, zq_time)
            ...
            zq_res = True
            zq_str = ""
            zq_temp = QS_200_Verify_Validity_Flag(self, NE1, zq_vc4_idx1, "ALL", "15-MIN", "LONG", 
            ...
            #
            #SKIPPED BECAUSE THIS TEST WILL WASTE TIME! MORE THAN 3 DAYS TO CHECK 15 COUNTERS FLAGS!
            #
            '''
            time.sleep(86400)

            zq_temp = QS_200_Verify_Validity_Flag(self, NE1, zq_vc4_idx1, "ALL", "1-DAY", "LONG", 
        ...
        print("\n******************************************************************************")
        print("\n       VERIFY VALIDITY FLAG LONG - 2xMVC4 in second block                      ")
        print("\n******************************************************************************")
        ...
        print("\n******************************************************************************")
        print("\n       VERIFY VALIDITY FLAG LONG - 2xMVC4 in third block                      ")
        print("\n******************************************************************************")
