...
:field Dependency:NA
:field Lab: SVT
:field TPS: PM__5-2-4-20
:field TPS: PM__5-2-5-44
:field TPS: PM__5-2-5-45
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-2-4-20")
        self.start_tps_block(NE1.id,"PM","5-2-5-44")
        ...
        TX_MEASURE_CH = "1"
        RX_MEASURE_CH = "1"
        zq_stmn_idx1 = "STM4{}-{}-{}".format(E_HOAU4,NE1_stmnp1,TX_MEASURE_CH)
        ...
        '''
        ONT1.get_set_tx_bit_rate(ONT1_P1, E_STM4)
        
        ONT1.get_set_rx_bit_rate(ONT1_P1, E_STM4)
        ...
        zq_stm4_idx1 = "STM4-{}".format(NE1_stmnp1)
        
        stm_size = E_STM4
        
        print("\n******************************************************************************")
        print("\n       SET PMMODE ON TO CREATE REGISTERS FOR STM4 FACILITIES                  ")
        print("\n******************************************************************************\n")
        
        QS_090_Set_PM_Mode(self, zq_stm4_idx1, "ALL", "ON", "BOTH","ALL",stm_size)
        
        print("\n******************************************************************************")
        print("\n       CHECK PMMODE STATE IS ON FOR STM4 REGISTERS                            ")
        print("\n******************************************************************************\n")
        
        QS_100_Check_PM_Mode(self, zq_stm4_idx1, "ALL", "BOTH","ALL",stm_size)
        
        print("\n******************************************************************************")
        print("\n VERIFY ALL PM PARAMETERS ARE INIZIALIZED TO ZERO WHEN REGISTERS ARE CREATED FOR STM4 FACILITIES ")
        print("\n******************************************************************************\n")
            
        QS_100_Check_BBE_ES_SES_UAS(self, ONT1_P1, zq_stm4_idx1, "ALL","BOTH","ALL",stm_size,"HPBIP")
        
        print("\n******************************************************************************")
        print("\n DELETE STM4 CROSS-CONNECTION AND SET PM MODE TO DISABLE")
        print("\n******************************************************************************\n")
        
        QS_050_Delete_HO_XC(self,E_HOVC4,zq_stmn_idx1,zq_stm64_idx2)
        
        QS_090_Set_PM_Mode(self, zq_stm4_idx1, "ALL", "DISABLED", "BOTH","ALL",stm_size)
            
        self.stop_tps_block(NE1.id,"PM", "5-2-4-20")
        self.stop_tps_block(NE1.id,"PM", "5-2-5-44")
        
        time.sleep(E_WAIT)
        
        self.start_tps_block(NE1.id,"PM","5-2-5-45")
        
        print("\n******************************************************************************")
        print("\nSETUP VC4-4C GROUP ON STM4 FACILITY USING ED-STM4 COMMAND AND CREATE CROSS-CONNECTION ")
        print("\n******************************************************************************\n")
        ...
        self.stop_tps_block(NE1.id,"PM", "5-2-5-45")
