...
def QS_150_Check_TCA(zq_run,
    ...
    if zq_cmd == (True,'COMPLD'):
        if zq_msg.get_cmd_response_size() == 0:
            dprint("OK\tTCA correctly NOT present for {}: [{}]-[{}]-[{}]-[{}]-[{}]".format(zq_vc4_idx, zq_cond_code, zq_cond_type, zq_sev, zq_locn, zq_dir),2)
            zq_run.add_success(NE1, "TL1 Command","0.0", "TCA correctly NOT present for {}: [{}]-[{}]-[{}]-[{}-[{}]]".format(zq_vc4_idx, zq_cond_code, zq_cond_type, zq_sev, zq_locn, zq_dir))
        else:
            zq_run.add_failure(NE1, "TL1 Command", "0.0", "TL1 Command", "TCA wrongly FOUND for {}: [{}]-[{}]-[{}]-[{}]-[{}]".format(zq_vc4_idx, zq_cond_code, zq_cond_type, zq_sev, zq_locn, zq_dir))
            dprint("KO\tTCA wrongly FOUND for {}: [{}]-[{}]-[{}]-[{}]-[{}]".format(zq_vc4_idx, zq_cond_code, zq_cond_type, zq_sev, zq_locn, zq_dir),2)
    else:
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-5-27-1")
        ...
        '''
        ### START ### Configure both ONT ports to VC3 mapping
        '''
        ...
        if QS_070_Check_No_Alarm(self, ONT_P1, ONT_P2, zq_vc4_ch1, zq_vc4_ch2):
            ...
            print("\n******************************************************************************")
            print("\n       SET MVC4 FACILITY OOS                                                  ")
            print("\n******************************************************************************")

            zq_tl1_res=NE1.tl1.do("ED-PTF::{}:::::OOS;".format(zq_vc4_idx1)) 
            zq_tl1_res=NE1.tl1.do("RTRV-PTF::{}::::PTFTYPE=MODVC4,PTFRATE=VC4;".format(zq_vc4_idx1))
            zq_msg=TL1message(NE1.tl1.get_last_outcome())
            zq_cmd=zq_msg.get_cmd_status()
            if zq_cmd == (True,'COMPLD'):
                ...
                if zq_pst.find("OOS") != -1:
                    ...
                    dprint("KO\t{} NOT set Out Of Service".format(zq_vc4_idx1),2)
                    self.add_failure(NE1, "TL1 Command", "0.0", "TL1 Command", "{} NOT set Out Of Service".format(zq_vc4_idx1))
            else:
                dprint("KO\tTL1 Command Failure:\r\n{}".format(zq_msg),2)
                self.add_failure(NE1, "TL1 Command Failure", "0.0", "TL1 Command Failure", "TL1 Command Failure:\r\n{}".format(zq_msg))
            ...
            print("\n******************************************************************************")
            print("\n       SET MVC4 FACILITY IS                                                   ")
            print("\n******************************************************************************")

            zq_tl1_res=NE1.tl1.do("ED-PTF::{}:::::IS;".format(zq_vc4_idx1))
            zq_tl1_res=NE1.tl1.do("RTRV-PTF::{}::::PTFTYPE=MODVC4,PTFRATE=VC4;".format(zq_vc4_idx1))
            zq_msg=TL1message(NE1.tl1.get_last_outcome())
            zq_cmd=zq_msg.get_cmd_status()
            if zq_cmd == (True,'COMPLD'):
                ...
                if zq_pst.find("IS") != -1:
                    ...
                    dprint("KO\t{} NOT set In Service".format(zq_vc4_idx1),2)
                    self.add_failure(NE1, "TL1 Command", "0.0", "TL1 Command", "{} NOT set In Service".format(zq_vc4_idx1))
            else:
                dprint("KO\tTL1 Command Failure:\r\n{}".format(zq_msg),2)
                self.add_failure(NE1, "TL1 Command Failure", "0.0", "TL1 Command Failure", "TL1 Command Failure:\r\n{}".format(zq_msg))
        ...
        self.stop_tps_block(NE1.id,"PM","5-5-27-1")
