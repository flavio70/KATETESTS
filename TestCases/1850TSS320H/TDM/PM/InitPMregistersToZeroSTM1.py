...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-2-4-19")
        self.start_tps_block(NE1.id,"PM","5-2-5-43")
        ...
        TX_MEASURE_CH = "1"
        RX_MEASURE_CH = "1"
        zq_stmn_idx1 = "STM1{}-{}-{}".format(E_HOAU4,NE1_stmnp1,TX_MEASURE_CH)
        ...
        '''
        ONT1.get_set_tx_bit_rate(ONT1_P1, E_STM1)
        
        ONT1.get_set_rx_bit_rate(ONT1_P1, E_STM1)
        ...
        zq_stm1_idx1 = "STM1-{}".format(NE1_stmnp1)
        ...
        QS_090_Set_PM_Mode(self, zq_stm1_idx1, "ALL", "ON", "BOTH","ALL",stm_size)
        
        print("\n******************************************************************************")
        print("\n       CHECK PMMODE STATE IS ON FOR STM16 REGISTERS                            ")
        print("\n******************************************************************************\n")
        
        QS_100_Check_PM_Mode(self, zq_stm1_idx1, "ALL", "BOTH","ALL",stm_size)
        
        print("\n******************************************************************************")
        print("\n VERIFY ALL PM PARAMETERS ARE INIZIALIZED TO ZERO WHEN REGISTERS ARE CREATED FOR STM16 FACILITIES ")
        print("\n******************************************************************************\n")
            
        QS_100_Check_BBE_ES_SES_UAS(self, ONT1_P1, zq_stm1_idx1, "ALL","BOTH","ALL",stm_size,"HPBIP")
        ...
        QS_090_Set_PM_Mode(self, zq_stm1_idx1, "ALL", "DISABLED", "BOTH","ALL",stm_size)
            
        self.stop_tps_block(NE1.id,"PM", "5-2-4-19")
        self.stop_tps_block(NE1.id,"PM", "5-2-5-43")
