...
:field Description: STM64 facilities and for higher order VCn facilities.
:field Topology: 42
:field Dependency:NA
:field Lab: SVT
:field TPS: PM__5-2-4-22
:field TPS: PM__5-2-5-49
:field TPS: PM__5-2-5-50
:field TPS: PM__5-2-5-51
:field TPS: PM__5-2-5-52
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-2-4-22")
        self.start_tps_block(NE1.id,"PM","5-2-5-49")
        ...
        print("\n******************************************************************************")
        print("\n VERIFY ALL PM PARAMETERS ARE INIZIALIZED TO ZERO WHEN REGISTERS ARE CREATED FOR STM64 FACILITIES ")
        print("\n******************************************************************************\n")
            
        QS_100_Check_BBE_ES_SES_UAS(self, ONT1_P1, zq_stm64_idx1, "ALL","BOTH","ALL",stm_size,"HPBIP")
        
        print("\n******************************************************************************")
        print("\n DELETE STM64 CROSS-CONNECTION AND SET PM MODE TO DISABLE")
        print("\n******************************************************************************\n")
        ...
        self.stop_tps_block(NE1.id,"PM", "5-2-4-22")
        self.stop_tps_block(NE1.id,"PM", "5-2-5-49")
        
        time.sleep(E_WAIT)
        
        self.start_tps_block(NE1.id,"PM","5-2-5-50")
        ...
        rateVC4XC = [4,16,64]
        zq_au44c_idx1 = "{}{}-{}-{}".format(stmrate[1],E_HOAU4NC,NE1_stmnp1,TX_MEASURE_CH)
        ...
        self.stop_tps_block(NE1.id,"PM", "5-2-5-50")
        
        
        self.start_tps_block(NE1.id,"PM","5-2-5-51")
        ...
        self.stop_tps_block(NE1.id,"PM", "5-2-5-51")
        
        self.start_tps_block(NE1.id,"PM","5-2-5-52")
        ...
        print("\n******************************************************************************")
        print("\n       ENABLE PM ON AU4-64C using SET-PMMODE-VCn COMMAND  ")
        print("\n******************************************************************************\n")
        ...
        QS_100_Check_BBE_ES_SES_UAS(self, ONT1_P1, zq_au464c_idx1, "ALL","BOTH","ALL",vc4_nc_size,"HPBIP")
        ...
        self.stop_tps_block(NE1.id,"PM", "5-2-5-52")
