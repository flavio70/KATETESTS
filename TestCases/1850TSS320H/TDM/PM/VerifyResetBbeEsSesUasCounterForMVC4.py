...
:field Description: PM counters for MVC4 facilities when counters reset is triggered.
:field Topology: 5
:field Dependency: NA
:field Lab: SVT
:field TPS: PM__5-5-11-1
:field TPS: PM__5-5-11-2
:field TPS: PM__5-5-11-3
:field TPS: PM__5-5-11-4
:field TPS: PM__5-5-11-5
:field TPS: PM__5-5-11-6
:field TPS: PM__5-5-11-7
:field TPS: PM__5-5-11-8
:field TPS: PM__5-5-11-9
:field TPS: PM__5-5-11-10
:field TPS: PM__5-5-11-11
:field TPS: PM__5-5-11-12
:field TPS: PM__5-5-11-13
:field TPS: PM__5-5-11-14
:field TPS: PM__5-5-11-15
:field TPS: PM__5-5-11-16
...
def QS_040_Modify_AU4_HO_Trace_Block(zq_run, zq_slot, zq_start_block, zq_block_size, zq_trace):
    ...
    while zq_i < (zq_start_block+zq_block_size):
        ...
        if zq_cmd == (True,'COMPLD'):
            ...
            zq_run.add_failure(NE1, "TL1 COMMAND","0.0", "TL1 COMMAND FAIL", "HO Trace Identifier change failure for STM64AU4-{}-{} {}".format(zq_slot,zq_i,QS_000_Print_Line_Function()))
...
def QS_050_Modify_MVC4_HO_Trace_Block(zq_run, zq_slot, zq_start_block, zq_block_size, zq_trace):
    ...
    while zq_i < (zq_start_block+zq_block_size):
        ...
        if zq_cmd == (True,'COMPLD'):
            ...
            zq_run.add_failure(NE1, "TL1 COMMAND","0.0", "TL1 COMMAND FAIL", "HO Trace Identifier change failure for MVC4-{}-{} {}".format(zq_slot,zq_i,QS_000_Print_Line_Function()))
        zq_i += 1
    return
...
def QS_060_Delete_LO_XC_Block(zq_run, zq_vc4_1, zq_vc4_2, zq_xc_list):
    ...
    for zq_j in range (1,4):
        ...
        if zq_cmd == (True,'COMPLD'):
            ...
            zq_run.add_failure(NE1, "TL1 COMMAND","0.0", "TL1 COMMAND FAIL", "Cross-connection deletion failed from {}-{} to {}-{} {}".format(zq_tu3_idx1,zq_j,zq_tu3_idx2,zq_j,QS_000_Print_Line_Function()))
...
def QS_090_Set_PM_Mode(zq_run, zq_vc4_idx, zq_locn, zq_mode, zq_period, zq_dir="RCV"):
    ...
    if zq_cmd == (True,'COMPLD'):
        ...
        zq_run.add_failure(NE1, "TL1 Command","0.0", "TL1 Command not successful", "PM set to {} for {}: [{}]-[{}]-[{}] {}".format(zq_mode, zq_vc4_idx,zq_locn,zq_dir,zq_period,QS_000_Print_Line_Function()))
    ...
    if zq_period == "BOTH" or zq_period == "1-DAY":  
        if zq_locn == "BIDIR":
            ...
            if  zq_bbe_ne != 0 and \
                ...
                zq_run.add_failure(NE1, "PM Counter Reading", "0.0", "PM Counter Reading", "Some PM counter [{}]-[1-DAY] for {} are still 0. {}".format(zq_locn, zq_vc4_idx1,QS_000_Print_Line_Function()))
...
def QS_110_Init_PM_Counter(zq_run, zq_vc4_idx, zq_locn, zq_period, zq_dir="RCV"):
    ...
    if zq_cmd == (True,'COMPLD'):
        ...
        zq_run.add_failure(NE1, "TL1 Command", "0.0", "TL1 Command", "PM  Counter Reset Command successful for {}: [{}]-[{}]-[{}] {}".format(zq_vc4_idx,zq_locn,zq_dir,zq_period,QS_000_Print_Line_Function()))
...
def QS_900_Set_Date(zq_date,zq_time):
    ...
    if zq_cmd == (True,'COMPLD'):
        ...
        zq_run.add_success(NE1, "TL1 Command","0.0", "NE date & time changed to {} & {}".format(zq_date,zq_time))
    else:
        dprint("KO\tNE date & time change failure",2)
        zq_run.add_failure(NE1, "TL1 Command", "0.0", "TL1 Command", "NE date & time change failure" + QS_000_Print_Line_Function())
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-5-11-1")
        self.start_tps_block(NE1.id,"PM","5-5-11-2")
        self.start_tps_block(NE1.id,"PM","5-5-11-3")
        self.start_tps_block(NE1.id,"PM","5-5-11-4")
        self.start_tps_block(NE1.id,"PM","5-5-11-5")
        self.start_tps_block(NE1.id,"PM","5-5-11-6")
        self.start_tps_block(NE1.id,"PM","5-5-11-7")
        self.start_tps_block(NE1.id,"PM","5-5-11-8")
        self.start_tps_block(NE1.id,"PM","5-5-11-9")
        self.start_tps_block(NE1.id,"PM","5-5-11-10")
        self.start_tps_block(NE1.id,"PM","5-5-11-11")
        self.start_tps_block(NE1.id,"PM","5-5-11-12")
        self.start_tps_block(NE1.id,"PM","5-5-11-13")
        self.start_tps_block(NE1.id,"PM","5-5-11-14")
        self.start_tps_block(NE1.id,"PM","5-5-11-15")
        self.start_tps_block(NE1.id,"PM","5-5-11-16")
        ...
        if QS_070_Check_No_Alarm(self, ONT_P1, ONT_P2, zq_vc4_ch1, zq_vc4_ch2):
            ...
            if QS_120_Verify_PM_Counter_Zero(self, zq_vc4_idx1) == 0:
                ...
                self.add_failure(NE1, "PM counter reset","0.0", "PM counter reset not successful", "Some PM counters were NOT reset " + QS_000_Print_Line_Function())
        ...
        if QS_070_Check_No_Alarm(self, ONT_P1, ONT_P2, zq_vc4_ch1, zq_vc4_ch2):
            ...
            QS_090_Set_PM_Mode(self, zq_vc4_idx1, "BIDIR", "ON", "BOTH")
        ...
        self.stop_tps_block(NE1.id,"PM","5-5-11-1")
        self.stop_tps_block(NE1.id,"PM","5-5-11-2")
        self.stop_tps_block(NE1.id,"PM","5-5-11-3")
        self.stop_tps_block(NE1.id,"PM","5-5-11-4")
        self.stop_tps_block(NE1.id,"PM","5-5-11-5")
        self.stop_tps_block(NE1.id,"PM","5-5-11-6")
        self.stop_tps_block(NE1.id,"PM","5-5-11-7")
        self.stop_tps_block(NE1.id,"PM","5-5-11-8")
        self.stop_tps_block(NE1.id,"PM","5-5-11-9")
        self.stop_tps_block(NE1.id,"PM","5-5-11-10")
        self.stop_tps_block(NE1.id,"PM","5-5-11-11")
        self.stop_tps_block(NE1.id,"PM","5-5-11-12")
        self.stop_tps_block(NE1.id,"PM","5-5-11-13")
        self.stop_tps_block(NE1.id,"PM","5-5-11-14")
        self.stop_tps_block(NE1.id,"PM","5-5-11-15")
        self.stop_tps_block(NE1.id,"PM","5-5-11-16")
