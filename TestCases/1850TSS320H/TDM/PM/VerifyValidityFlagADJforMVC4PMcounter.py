...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"PM","5-5-19-1")
        self.start_tps_block(NE1.id,"PM","5-5-19-2")
        ...
        print("\n******************************************************************************")
        print("\n       VERIFY VALIDITY FLAG ADJ - 2xMVC4 in first block                       ")
        print("\n******************************************************************************")
        ...
        if QS_070_Check_No_Alarm(self, NE1, ONT, ONT_P1, ONT_P2, zq_vc4_ch1, zq_vc4_ch2):
            ...
            QS_100_Check_BBE_ES_SES_UAS(self, NE1, ONT, ONT_P1, ONT_P2, zq_mtxlo_slot, zq_vc4_idx1, zq_vc4_idx2, "NEND","BOTH","RCV","HPBIP")
            QS_100_Check_BBE_ES_SES_UAS(self, NE1, ONT, ONT_P1, ONT_P2, zq_mtxlo_slot, zq_vc4_idx1, zq_vc4_idx2, "FEND","BOTH","RCV","HPREI")
            QS_100_Check_BBE_ES_SES_UAS(self, NE1, ONT, ONT_P1, ONT_P2, zq_mtxlo_slot, zq_vc4_idx1, zq_vc4_idx2, "BIDIR","1-DAY","RCV","HPBIP")
            QS_100_Check_BBE_ES_SES_UAS(self, NE1, ONT, ONT_P1, ONT_P2, zq_mtxlo_slot, zq_vc4_idx1, zq_vc4_idx2, "BIDIR","1-DAY","RCV","HPREI")

            #VERIFY FLAG IS COMPL
            zq_res = True
            zq_str = ""
            zq_temp = QS_200_Verify_Validity_Flag(self, NE1, zq_vc4_idx1, "ALL", "BOTH", "COMPL", 
            ...
            QS_110_Init_PM_Counter(self, NE1, zq_vc4_idx1, "NEND", "15-MIN")
            QS_110_Init_PM_Counter(self, NE1, zq_vc4_idx1, "NEND", "1-DAY")
            QS_110_Init_PM_Counter(self, NE1, zq_vc4_idx1, "FEND", "15-MIN")
            QS_110_Init_PM_Counter(self, NE1, zq_vc4_idx1, "FEND", "1-DAY")
            QS_110_Init_PM_Counter(self, NE1, zq_vc4_idx1, "BIDIR", "1-DAY")
            
            time.sleep(5)

            zq_res = QS_120_Verify_PM_Counter_Zero(self, NE1, zq_vc4_idx1)
            if zq_res == 0:
                ...
                self.add_failure(NE1, "PM Counter Reading", "0.0", "PM Counter Reading", "Some PM counter for {} are not 0. {}".format(zq_vc4_idx1,QS_000_Print_Line_Function()))
                dprint("KO\tSome PM counter for {} are not 0.".format(zq_vc4_idx1),2)

            #VERIFY FLAG IS ADJ
            zq_res = True
            zq_str = ""
            zq_temp = QS_200_Verify_Validity_Flag(self, NE1, zq_vc4_idx1, "ALL", "BOTH", "ADJ", 
        ...
        print("\n******************************************************************************")
        print("\n       VERIFY VALIDITY FLAG ADJ - 2xMVC4 in second block                      ")
        print("\n******************************************************************************")
        ...
        self.stop_tps_block(NE1.id,"PM","5-5-19-1")
        self.stop_tps_block(NE1.id,"PM","5-5-19-2")
