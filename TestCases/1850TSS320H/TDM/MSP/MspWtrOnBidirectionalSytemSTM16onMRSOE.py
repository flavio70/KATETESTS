...
:field Description:  Verify the operation of WTR for a revertive bidirectional switching system on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-10-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-10-12")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-10-12")
