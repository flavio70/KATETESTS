...
:field Description:  Verify the FRCD switch request & it's priority of operation  on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-5-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-5-12")
        ...
        #FRCD switch on protection on NE1
        ...
        commandResult=NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::FRCD::DESTINATION=PROTN;"%(MSP__RATE,NE2_PROT_FACILITY),policy="DENY")
        ...
        NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::FRCD::DESTINATION=WKG;"%(MSP__RATE,NE2_PROT_FACILITY))
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(),"FFP%s"%(NE1_PROT_FACILITY), "FRCDWKSWBK-FE,SC")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "FRCDWKSWBK,SC")
        ...
        CheckCondition (self, NE1, msg, "FRCDWKSWBK-FE", "FFP%s"%(NE1_PROT_FACILITY),PrintLineFunction())
          
        NE2.tl1.do("RTRV-COND-FFP::FFP%s;"%(NE2_PROT_FACILITY))        

        msg=TL1message(NE2.tl1.get_last_outcome())
      
        CheckCondition (self, NE2, msg, "FRCDWKSWBK", "FFP%s"%(NE2_PROT_FACILITY),PrintLineFunction())
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"CURRREQ","FRCD-FE",PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","FRCD",PrintLineFunction())
        ...
        commandResult=NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::FRCD::DESTINATION=WKG;"%(MSP__RATE,NE2_PROT_FACILITY),policy="DENY")
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(),"FFP%s"%(NE1_PROT_FACILITY), "FRCDWKSWBK-FE,CL")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "FRCDWKSWBK,CL")
       ...
       #Generate signal failure    
        ...
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "WKSWBK-FE,SC")
        ...
        CheckCondition (self, NE2, msg, "WKSWBK-FE", "FFP%s"%(NE2_PROT_FACILITY),PrintLineFunction())
        ...
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "WKSWBK-FE,CL")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-5-12")
