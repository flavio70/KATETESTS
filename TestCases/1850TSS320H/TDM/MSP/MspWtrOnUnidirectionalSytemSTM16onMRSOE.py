...
:field Description:  Verify the operation of WTR for a revertive unidirectional switching system on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-9-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-9-12")
        ...
        #Edit revertive timer    
        
        NE1.tl1.do("ED-FFP-%s::FFP%s::::RVRTTIM=5;"%(MSP__RATE,NE1_PROT_FACILITY))        
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"RVRTTIM","5",PrintLineFunction())

        NE2.tl1.do("ED-FFP-%s::FFP%s::::RVRTTIM=3;"%(MSP__RATE,NE2_PROT_FACILITY))        
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"RVRTTIM","3",PrintLineFunction())
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-9-12")
