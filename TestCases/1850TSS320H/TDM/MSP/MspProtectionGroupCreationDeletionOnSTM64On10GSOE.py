...
:field Description: Verify the Linear MSP protection group creation and deletion on STM16 facility  
:field Topology: 10
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-2-1-19
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-2-1-19")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-2-1-19")
