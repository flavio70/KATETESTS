...
:field Description:  Verify the automatic protection switch conditions for a bidirectional switching on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-19-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-19-12")
        ...
        #Clear signal failure on working facility on NE1  
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-19-12")
