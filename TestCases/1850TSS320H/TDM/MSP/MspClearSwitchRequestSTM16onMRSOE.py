...
:field Description:  Verify the CLEAR switch request operation  on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-7-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-7-12")
        ...
        #Change to revertive mode    
        
        NE1.tl1.do("ED-FFP-%s::FFP%s::::RVRTV=Y,RVRTTIM=%s;"%(MSP__RATE,NE1_PROT_FACILITY,E_WTR_TIME_MINUTE))        
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"RVRTTIM","%s"%E_WTR_TIME_MINUTE,PrintLineFunction())

        NE2.tl1.do("ED-FFP-%s::FFP%s::::RVRTV=Y,RVRTTIM=%s;"%(MSP__RATE,NE2_PROT_FACILITY,E_WTR_TIME_MINUTE))        
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"RVRTTIM","%s"%E_WTR_TIME_MINUTE,PrintLineFunction())
       ...
       #Generate signal failure    
        ...
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "WTR-FE,SC")
        ...
        CheckCondition (self, NE2, msg, "WTR-FE", "FFP%s"%(NE2_PROT_FACILITY), PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","WTR-FE",PrintLineFunction())
        ...
        # Wait revertive timer expiration        
        ...
        CheckEvent (self, NE2, "A", PrintLineFunction(),"FFP%s"%(NE2_PROT_FACILITY), "WTR-FE,CL")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-7-12")
