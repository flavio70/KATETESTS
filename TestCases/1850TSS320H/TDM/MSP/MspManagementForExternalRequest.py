...
:field Description:  Verify the management for external request. (It can be executed on any STM and on any TDM card) 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-42-1
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-42-1")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-42-1")
