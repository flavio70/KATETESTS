...
:field Description:  Verify the MAN switch request & it's priority of operation  on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-4-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-4-12")
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "MANWKSWBK")
    
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "MANWKSWBK", False)
        ...
        commandResult=NE1.tl1.do("OPR-PROTNSW-%s::FFP%s:::MAN::DESTINATION=WKG;"%(MSP__RATE,NE1_PROT_FACILITY),policy="DENY")
        
        msg=TL1message(NE1.tl1.get_last_outcome())
        
        if commandResult:
           
           CheckErrorCode(self, NE1, msg, "SRQN",PrintLineFunction())

        #MAN denied on NE2
        
        commandResult=NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::MAN::DESTINATION=WKG;"%(MSP__RATE,NE2_PROT_FACILITY),policy="DENY")
        
        msg=TL1message(NE2.tl1.get_last_outcome())
        
        if commandResult:
           
           CheckErrorCode(self, NE2, msg, "SRQN",PrintLineFunction())
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"CURRREQ","DNR",PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","DNR",PrintLineFunction())
        ...
        NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::MAN::DESTINATION=WKG;"%(MSP__RATE,NE2_PROT_FACILITY))
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "MANWKSWBK-FE,SC")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "MANWKSWBK,SC")
        ...
        CheckCondition (self, NE1, msg, "MANWKSWBK-FE", "FFP%s"%(NE1_PROT_FACILITY), PrintLineFunction())
          
        NE2.tl1.do("RTRV-COND-FFP::FFP%s;"%(NE2_PROT_FACILITY))        

        msg=TL1message(NE2.tl1.get_last_outcome())
      
        CheckCondition (self, NE2, msg, "MANWKSWBK", "FFP%s"%(NE2_PROT_FACILITY), PrintLineFunction())
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"CURRREQ","MAN-FE",PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","MAN",PrintLineFunction())
        ...
        commandResult=NE1.tl1.do("OPR-PROTNSW-%s::FFP%s:::MAN::DESTINATION=PROTN;"%(MSP__RATE,NE1_PROT_FACILITY),policy="DENY")
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "MANWKSWBK-FE,CL")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "MANWKSWBK,CL")
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "FRCDWKSWPR,CL")

        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "FRCDWKSWPR-FE,CL")
       ...
       #Generate signal failure    
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "MANWKSWBK,CL")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "MANWKSWBK-FE,CL")

        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "WKSWPR,SC")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "WKSWPR-FE,SC")
        ...
        CheckCondition (self, NE2, msg, "WKSWPR-FE", "FFP%s"%(NE2_PROT_FACILITY), PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","SF-FE",PrintLineFunction())
        ...
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "WKSWPR-FE,CL")
        ...
        CheckCondition (self, NE1, msg, "LOCKOUTOFPR", "FFP%s"%(NE1_PROT_FACILITY), PrintLineFunction())
          
        NE2.tl1.do("RTRV-COND-FFP::FFP%s;"%(NE2_PROT_FACILITY))        

        msg=TL1message(NE2.tl1.get_last_outcome())
      
        CheckCondition (self, NE2, msg, "LOCKOUTOFPR-FE", "FFP%s"%(NE2_PROT_FACILITY), PrintLineFunction())
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "LOCKOUTOFPR,CL")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "LOCKOUTOFPR-FE,CL")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-4-12")
