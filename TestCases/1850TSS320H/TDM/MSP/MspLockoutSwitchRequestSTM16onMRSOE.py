...
:field Description:  Verify the LOCKOUT switch request & it's priority of operation  on STM16 facility on MRSOE 
:field Topology: 7
:field Dependency:
:field Lab: SVT
:field TPS:  MSP__5-3-6-12
:field TPS: 
...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        self.start_tps_block(NE1.id,"MSP", "5-3-6-12")
        ...
        commandResult=NE1.tl1.do("OPR-PROTNSW-%s::FFP%s:::FRCD::DESTINATION=PROTN;"%(MSP__RATE,NE1_PROT_FACILITY),policy="DENY")
        ...
        NE2.tl1.do("OPR-PROTNSW-%s::FFP%s:::LOCKOUT::DESTINATION=WKG;"%(MSP__RATE,NE2_PROT_FACILITY))
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "LOCKOUTOFPR-FE,SC")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "LOCKOUTOFPR,SC")
    
        NE1.tl1.do("RTRV-COND-FFP::FFP%s;"%(NE1_PROT_FACILITY))        

        msg=TL1message(NE1.tl1.get_last_outcome())
      
        CheckCondition (self, NE1, msg, "LOCKOUTOFPR-FE", "FFP%s"%(NE1_PROT_FACILITY), PrintLineFunction())
          
        NE2.tl1.do("RTRV-COND-FFP::FFP%s;"%(NE2_PROT_FACILITY))        

        msg=TL1message(NE2.tl1.get_last_outcome())
      
        CheckCondition (self, NE2, msg, "LOCKOUTOFPR", "FFP%s"%(NE2_PROT_FACILITY), PrintLineFunction())
        ...
        CheckParameterValue(self,NE1,msg,"FFP%s"%NE1_PROT_FACILITY,"CURRREQ","LOCKOUT-FE",PrintLineFunction())
        ...
        CheckParameterValue(self,NE2,msg,"FFP%s"%NE2_PROT_FACILITY,"CURRREQ","LOCKOUT",PrintLineFunction())
        ...
        NE2.tl1.do("RLS-PROTNSW-%s::FFP%s;"%(MSP__RATE,NE2_PROT_FACILITY))
        ...
        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "LOCKOUTOFPR-FE,CL")

        CheckEvent (self, NE1, "A", PrintLineFunction(), "FFP%s"%(NE1_PROT_FACILITY), "WKSWPR-FE,SC")
    
        CheckEvent (self, NE2, "A", PrintLineFunction(), "FFP%s"%(NE2_PROT_FACILITY), "LOCKOUTOFPR,CL")
        ...
        self.stop_tps_block(NE1.id,"MSP", "5-3-6-12")
